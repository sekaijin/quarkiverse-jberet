...
@QuarkusTest
public class SplitFlowTransitionLoopTests extends com.ibm.jbatch.tck.tests.jslxml.SplitFlowTransitionLoopTests {
    @Inject
    ...
    public void testSplitFlowTransitionLoopSplitFlowSplit() throws Exception {
        super.testSplitFlowTransitionLoopSplitFlowSplit();
    }
}
