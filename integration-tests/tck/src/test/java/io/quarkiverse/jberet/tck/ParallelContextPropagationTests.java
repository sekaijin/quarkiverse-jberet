...
@QuarkusTest
public class ParallelContextPropagationTests extends com.ibm.jbatch.tck.tests.jslxml.ParallelContextPropagationTests {
    @Inject
    ...
    public void testPartitionContextPropagation() throws Exception {
        super.testPartitionContextPropagation();
    }

    @Test
    public void testSplitFlowContextPropagation() throws Exception {
        super.testSplitFlowContextPropagation();
    }
}
