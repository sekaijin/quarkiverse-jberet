...
@QuarkusTest
public class ListenerOnErrorTests extends com.ibm.jbatch.tck.tests.jslxml.ListenerOnErrorTests {
    @Inject
    ...
    public void testOnWriteErrorItems() throws Exception {
        super.testOnWriteErrorItems();
    }

    @Test
    public void testOnProcessErrorItems() throws Exception {
        super.testOnProcessErrorItems();
    }
}
